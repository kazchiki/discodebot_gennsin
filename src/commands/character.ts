...
import { saveUserCharacter, getUserUID } from '../utils/userData';

export async function handleCharacterCommand(interaction: ChatInputCommandInteraction): Promise<void> {
...
export async function showCharacterDetails(interaction: ChatInputCommandInteraction | ButtonInteraction, uid: string, characterId: string): Promise<void> {
    try {
